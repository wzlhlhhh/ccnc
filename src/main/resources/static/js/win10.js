...
//            ['<i class="fa fa-fw fa-info-circle"></i> '+Win10.lang('关于','About Us'),function () {Win10.aboutUs()}],
    ...
    exit:function () {
        layer.confirm(Win10.lang('确认要退出系统吗?','Are you sure you want to logout this System?'), {icon: 3, title:Win10.lang('提示','Prompt')}, function(index){
            document.body.onbeforeunload = function(){};
            window.location.href="/vone/jyxh-admin";
            window.close();
            layer.close(index);
